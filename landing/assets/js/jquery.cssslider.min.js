(function ($, window, document, undefined) {
    var pluginName = "AnimatedSlider", defaults = {infiniteScroll: true, visibleItems: 3, changedCallback: null, willChangeCallback: null, userChangedCallback: null, useTransitions: true};
    ...
    Plugin.prototype.setItem = function (n) {
        ...
        var wrapFunc;
        if (this.options.infiniteScroll) wrapFunc = this._wrapIndex; else wrapFunc = wrapFuncNone;
        for (var i = 0; i < sliderItems.length; i++) {
            var item = sliderItems.eq(i);
            if (i == n) item.addClass("current_item"); else if (i < n) item.addClass("previous_hidden"); else if (i > n) item.addClass("next_hidden")
        }
